      ...
      <footer className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-12 mx-auto">
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            <div className="flex justify-center items-center " onClick={e => window.scrollTo(0, 0)}>
              <img
            ...
            <div className="flex justify-center items-center gap-x-4 mt-12">
              <div className="opacity-50 w-8 h-8 flex-shrink-0  cursor-pointer rounded-full flex items-center justify-center">
                <svg
