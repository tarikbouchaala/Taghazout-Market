...
function CategoryTable() {
  ...
  // console.log('Isopen from category',isOpen)
      ...
      <div className="w-full	px-5 mx-auto mt-14 ">
        <div className="flex justify-between bg-gray-100 p-4">
          ...
          <div className="flex items-center">
            <NavLink to={"/dashboard/admin/category/add"}>
        ...
        <div className="relative w-full shadow-md sm:rounded-lg  divide-orange-500">
                      ...
                      >
                        <td>
                          <img
                            src={category.image}
                            alt="Apple Watch"
                            className="max-h-[calc(137px)] w-[calc(96px)] "
                          />
                        </td>
                        ...
                        <td className="px-6 py-4">
                          <div className="flex">
                            ...
                            <button
                              ...
                              // onClick={(e) => HandelDeleteCategory(category)}
        ...
        {/* <ConfirmDeleteModal Open ={isOpen} HandelDeleteItem={HandelDeleteCategory}  /> */}
      </div>
    </div>
  );
}
